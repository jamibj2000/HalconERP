...
const TipoIdentidad = () => {
    ...
    const endPointLastUrl = 'tipoIdentidad'; /// url for service
    ...
    return (
        ...
        <FormContainer progress="45" style={{ width: '60%' }}>
            ...
            {/* TABLE */}
            <Table
                titleColumn={['Id','Abreviatura', 'Descripción', 'Actualizar', 'Eliminar']}
                data={dataTable}
                attributes={['Abr', 'Descripcion']} //codigo
                onDelete={onDelete}
                onUpdate={onUpdate}
            ></Table>
