          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="form-group">
              ...
              >
                <option>Seleccionar</option>
                <option value={1}>
                  Obtener valor de la tabla de bases de datos 'IdActaGestionCompromisos'
            ...
            <div className="form-group">
            <label className="d-block">Descripción ruta </label>
            <textarea 
             value={descripcion}
