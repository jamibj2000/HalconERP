...
const ModalidadesTac = () => {
    ...
    const endPointLastUrl = 'modalidadesTac'; //! endPointLastUrl
    ...
    return (
        ...
        <FormContainer progress="45" style={{ width: '60%' }}>
            ...
            <button
                ...
                onClick={onCreate}
            >
                Agregar modalidades estado académico
            </button>
            {/* TABLE */}
            <Table
                titleColumn={[
