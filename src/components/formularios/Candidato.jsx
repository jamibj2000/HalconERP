...
const Candidato = () => {
  ...
  const handleSubmit = (e) => {
    console.log( identificacion, apellido, apellido2, nombre, nombre2, telefono, direccion, especialidad, archivos, actividades, perfil, programa, proceso, observacion, pais, perfil1, tipo, calificacion, deposito, url, codigo);
    e.preventDefault();
  }
  return (
            ...
            <div className="row">
              <div className="col-md-6">
                <div className="form-group">
                  ...
                  <input value={identificacion} onChange={e => setIdentificacion(e.target.value)} type="text" className="form-control" />
                </div>
                <div className="form-group">
                ...
                <div className="form-group">
                  ...
                  <input value={archivos} onChange={e => setArchivos(e.target.value)} type="text" className="form-control" />
                </div>
                <div className="form-group">
                  <label className="d-block">Perfil:</label>
                  <div className="form-check form-check-inline" role="group" aria-label="Basic checkbox toggle button group">
                    <input value={perfil} onChange={e => setPerfil(e.target.value)} type="checkbox" className="form-check-input" id="btn-checkoffer" autoComplete="off"/>
                ...
                <div className="form-group">
                  ...
                  <select value={actividades} onChange={e => setActividades(e.target.value)} className="form-control">
              ...
              <div className="col-md-6">
                <div className="form-group">
                  <label> País </label>
                  <select value={pais} onChange={e => setPais(e.target.value)} className="form-control">
                    <option>Seleccionar</option>
                    <option value={1}>
                ...
                <div className="form-group">
                  <label>Perfil</label>
                  <select value={perfil1} onChange={e => setPerfil1(e.target.value)} className="form-control">
                    <option>Seleccionar</option>
                    <option value={1}>
                ...
                <div className="form-group">
                  ...
                  <div className="form-check form-check-inline" role="group" aria-label="Basic checkbox toggle button group">
                    <input value={calificacion} onChange={e => setCalificacion(e.target.value)} type="checkbox" className="form-check-input" id="btn-checkcalification" autoComplete="off"/>
                    <label className="form-check-label" htmlFor="btn-checkcalification">
                ...
                <div className="form-group">
                  ...
                  <input value={deposito} onChange={e => setDeposito(e.target.value)}type="file" className="form-control" defaultValue="https://..."/>
                </div>
                <div className="form-group">
                  <label> Url </label>
                  <input value={url} onChange={e => setUrl(e.target.value)} type="text" className="form-control" placeholder="https://..."/>
                </div>
                <div className="form-group">
                  <label> Código </label>
                  <input value={codigo} onChange={e => setCodigo(e.target.value)} ype="text" className="form-control" />
                </div>
                <div className="form-group">
                  <label> Programa de estudios</label>
                  <select value={programa} onChange={e => setPrograma(e.target.value)} className="form-control">
                    <option>Seleccionar</option>
                    <option value={1}>
                ...
                <div className="form-group">
                  ...
                  <select value={proceso} onChange={e => setProceso(e.target.value)} className="form-control">
                    <option>Seleccionar</option>
                    <option value={1}>
                ...
                <div className="form-group">
                  ...
                  <textarea value={observacion} onChange={e => setObservacion(e.target.value)} className="form-control" id="floatingTextarea"/>
                </div>
              </div>
            </div>
